...
import { Bot, Calendar, Briefcase, Users, ArrowRight, Activity, Zap, Settings, MapPin, Flag, Building2 } from 'lucide-react';

export const TenantDashboard: React.FC = () => {
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8 h-full overflow-y-auto">
      {/* Welcome Section */}
