  ...
  return (
    <div className="h-full flex flex-col p-8 space-y-6 overflow-auto">
      <div className="flex justify-between items-center">
        ...
        <button 
          onClick={handleSave}
          className="glass-button flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-medium text-white hover:bg-secondary/20 hover:border-secondary/50 transition-all"
        >
            ...
            <div className="glass-panel p-8 rounded-2xl space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  />
                  <button className="bg-secondary hover:bg-secondary-light text-white px-6 py-3 rounded-lg font-medium transition-colors">
                    Adicionar
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 mt-6">
                ...
                <div className="flex justify-between items-center bg-black/50 p-3 rounded text-sm font-mono text-gray-300 border border-white/5">
                  <span className="text-secondary-light">CNAME</span>
                  <span>app</span>
                  <span>cname.hermes.app</span>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'Equipe' && (
            <div className="glass-panel p-8 rounded-2xl space-y-6">
              <div className="flex justify-between items-center border-b border-white/10 pb-4 mb-4">
                ...
                <button className="bg-secondary hover:bg-secondary-light text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors shadow-lg shadow-secondary/20">
                  <Plus size={16} />
                  Convidar Membro
                </button>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex justify-between items-center bg-white/5 p-4 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center font-bold text-sm text-white border border-white/10">
            ...
            <div className="glass-panel p-8 rounded-2xl space-y-6">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <button className="bg-secondary hover:bg-secondary-light text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-lg shadow-secondary/20">
                    Configurar 2FA
                  </button>
                </div>
